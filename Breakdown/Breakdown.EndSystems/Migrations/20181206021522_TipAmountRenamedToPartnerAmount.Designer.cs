...
namespace Breakdown.EndSystems.Migrations
{
    ...
    [Migration("20181206021522_TipAmountRenamedToPartnerAmount")]
    partial class TipAmountRenamedToPartnerAmount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Breakdown.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("HasADuePayment");

                    b.Property<bool>("HasAPaymentMethod");
            ...
            modelBuilder.Entity("Breakdown.Domain.Entities.ExpiredToken", b =>
                {
                    b.Property<int>("ExpiredTokenId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Breakdown.Domain.Entities.PartnerPayment", b =>
                {
                    b.Property<int>("PartnerPaymentId")
                        .ValueGeneratedOnAdd();

                    b.Property<decimal>("CardAppFee")
                        .HasColumnType("decimal(15, 2)");

                    b.Property<decimal>("CashAppFee")
                        .HasColumnType("decimal(15, 2)");
                    ...
                    b.Property<decimal>("TotalCardEarning")
                        .HasColumnType("decimal(15, 2)");

                    b.Property<int?>("TotalCardJobs");

                    b.Property<decimal>("TotalCashAmount")
                        .HasColumnType("decimal(15, 2)");

                    b.Property<decimal>("TotalCashEarning")
                        .HasColumnType("decimal(15, 2)");

                    b.Property<int?>("TotalCashJobs");

                    b.HasKey("PartnerPaymentId");

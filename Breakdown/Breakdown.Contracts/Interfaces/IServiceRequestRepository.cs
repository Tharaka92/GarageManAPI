...
namespace Breakdown.Contracts.Interfaces
{
    public interface IServiceRequestRepository
    {
        ...
        Task<int> UpdatePaymentDetailsAsync(int serviceRequestId, decimal totalAmount, decimal packagePrice, decimal tipAmount, string paymentStatus, string paymentType);
    }
}
